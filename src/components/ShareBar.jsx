...
export default function ShareBar({ text, title, downloadBlob, downloadFilename }) {
  ...
  const handleLinkedin = async (e) => {
    ...
    setLinkedinMsg(true)
    setTimeout(() => setLinkedinMsg(false), 4000)
  ...
  const handleFacebook = async (e) => {
    ...
    setFacebookMsg(true)
    setTimeout(() => setFacebookMsg(false), 4000)
  ...
  return (
    <div className="share-bar">
      ...
      <a
        ...
        title={linkedinMsg ? 'Text kopiert! Fuege mit Strg+V ein' : 'Auf LinkedIn teilen'}
      >
        ...
        <span className="share-btn-label">{linkedinMsg ? 'Strg+V!' : 'LinkedIn'}</span>
      </a>
      ...
      <a
        ...
        title={facebookMsg ? 'Text kopiert! Fuege mit Strg+V ein' : 'Auf Facebook teilen'}
      >
        <div className="share-btn-circle facebook">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
        </div>
        <span className="share-btn-label">{facebookMsg ? 'Strg+V!' : 'Facebook'}</span>
      </a>
