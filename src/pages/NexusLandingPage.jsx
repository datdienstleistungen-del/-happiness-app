...
import { Radar, Target, TrendingUp, ShieldAlert, ArrowRight, Zap, Activity, CheckCircle, Lock, Shield } from 'lucide-react'
    ...
    <div className="nexus-page">
      <nav className="nexus-nav">
        ...
        <div className="nexus-nav-links">
          {user ? (
            <Link to="/nexus/dashboard" className="nexus-btn-primary">Zum Dashboard</Link>
          ) : (
      ...
      <header className="nexus-hero">
        ...
        <div className="nexus-cta-group">
          <button className="nexus-btn-huge" onClick={() => navigate(user ? '/nexus/dashboard' : '/login')}>
      ...
      <section className="nexus-features">
        <div className="nexus-feature-card">
          ...
          <h3>Laser-Fokus</h3>
          <p>Finde Vorstände, Entscheider oder Händler exakt in der Sekunde, in der sie auf Plattformen oder in PR-Mitteilungen akuten Bedarf signalisieren.</p>
        </div>
        <div className="nexus-feature-card">
          <Activity size={32} className="nexus-icon" />
          <h3>Echtzeit-Trigger</h3>
          <p>Warum Wochen warten? NeXus alarmiert dich bei Trigger-Events (z.B. Neueröffnungen, Managementwechsel, Expansionen), bevor deine Konkurrenz überhaupt davon erfährt.</p>
        </div>
        <div className="nexus-feature-card">
          <Zap size={32} className="nexus-icon" />
          <h3>KI-Sales-Psychologie</h3>
          <p>Lass unsere elitäre Sales-KI den perfekten Eisbrecher formulieren. Subtil, extrem konvertierend und psychologisch optimiert auf das konkrete Signal.</p>
        </div>
      </section>
      ...
      <section className="nexus-manual">
        ...
        <div className="nexus-manual-steps">
          ...
          <div className="nexus-step">
            ...
            <div className="nexus-step-content">
              ...
              <p>Du sagst der KI in den Einstellungen exakt, was du verkaufst (z.B. "Logistik", "Software", "Consulting"). Dann wählst du deine Zielregion und dein Keyword. Unsere KI durchforstet ab sofort in Echtzeit über 100 globale News-Feeds, Fachforen und PR-Mitteilungen nach passenden Trigger-Events für dein Angebot.</p>
            </div>
          </div>
          ...
          <div className="nexus-step">
            ...
            <div className="nexus-step-content">
              ...
              <p>Das Radar liefert dir verifizierte Leads mit klaren Kategorien. <strong>News Radar:</strong> Perfekt für Glückwünsche zur Expansion. <strong>Forum & PR:</strong> Eine konkrete Herausforderung oder Neuaufstellung. <strong>Job Board:</strong> Zeigt an, dass ein Unternehmen umstrukturiert. Du siehst den Schmerz des Kunden auf den ersten Blick.</p>
            </div>
          </div>
          ...
          <div className="nexus-step">
            ...
            <div className="nexus-step-content">
              ...
              <p>Klicke auf den Link zur Originalquelle, verifiziere den Namen des erwähnten Managers oder Autors, suche ihn auf LinkedIn oder per E-Mail und schicke ihm exakt den Text, den NeXus für dich generiert hat. Du nutzt Gratulationen und Schmerzpunkte als Hebel, um ein Gespräch anzufangen. Ganz ohne Konkurrenz.</p>
            </div>
          </div>
        </div>
        ...
        <div className="nexus-cta-group" style={{ marginTop: '50px' }}>
          ...
          <p className="nexus-guarantee"><Shield size={16} /> 100% DSGVO-konform (Art. 6 Abs. 1 lit. f). Kein E-Mail-Raten.</p>
        </div>
      </section>
      ...
      <section className="nexus-social-proof">
        ...
        <button className="nexus-btn-secondary" onClick={() => navigate(user ? '/nexus/dashboard' : '/login')}>
