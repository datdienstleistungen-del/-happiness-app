...
const translations = {
  de: {
    ...
    nav: { home: 'Start', community: 'Community', friends: 'Freunde', marketplace: 'Marktplatz', jobs: 'Jobbörse', courses: 'Kurse', housing: 'Wohnungen', profile: 'Profil', notifications: 'Benachrichtigungen', history: 'Verlauf', admin: 'Admin', logout: 'Logout', aiChat: 'AI Chat', videoMaker: 'Video Editor', more: 'Mehr', videoFinder: 'Video Finder', videoScript: 'Video-Drehbuch', capcutStudio: 'CapCut Studio' },
  ...
  en: {
    ...
    nav: { home: 'Home', community: 'Community', friends: 'Friends', marketplace: 'Marketplace', jobs: 'Jobs', courses: 'Courses', housing: 'Housing', profile: 'Profile', notifications: 'Notifications', history: 'History', admin: 'Admin', logout: 'Logout', aiChat: 'AI Chat', videoMaker: 'Video Editor', more: 'More', videoFinder: 'Video Finder', videoScript: 'Video Script', capcutStudio: 'CapCut Studio' },
  ...
  es: {
    ...
    nav: { home: 'Inicio', community: 'Comunidad', friends: 'Amigos', marketplace: 'Mercado', jobs: 'Empleos', courses: 'Cursos', housing: 'Viviendas', profile: 'Perfil', notifications: 'Notificaciones', history: 'Historial', admin: 'Admin', logout: 'Salir', aiChat: 'AI Chat', videoMaker: 'Editor de Video', more: 'Más', videoFinder: 'Buscador de Videos', videoScript: 'Guion de Video', capcutStudio: 'CapCut Studio' },
  ...
  it: {
    ...
    nav: { home: 'Home', community: 'Community', friends: 'Amici', marketplace: 'Mercato', jobs: 'Lavori', courses: 'Corsi', housing: 'Alloggi', profile: 'Profilo', notifications: 'Notifiche', history: 'Cronologia', admin: 'Admin', logout: 'Esci', aiChat: 'AI Chat', videoMaker: 'Editor Video', more: 'Altro', videoFinder: 'Cerca Video', videoScript: 'Copione Video', capcutStudio: 'CapCut Studio' },
  ...
  nl: {
    ...
    nav: { home: 'Home', community: 'Community', friends: 'Vrienden', marketplace: 'Marktplaats', jobs: 'Banen', courses: 'Cursussen', housing: 'Woningen', profile: 'Profiel', notifications: 'Meldingen', history: 'Geschiedenis', admin: 'Admin', logout: 'Uitloggen', aiChat: 'AI Chat', videoMaker: 'Video Editor', more: 'Meer', videoFinder: 'Videozoeker', videoScript: 'Videoscenario', capcutStudio: 'CapCut Studio' },
  ...
  el: {
    ...
    nav: { home: 'Αρχική', community: 'Κοινότητα', friends: 'Φίλοι', marketplace: 'Αγορά', jobs: 'Εργασίες', courses: 'Μαθήματα', housing: 'Κατοικίες', profile: 'Προφίλ', notifications: 'Ειδοποιήσεις', history: 'Ιστορικό', admin: 'Διαχειριστής', logout: 'Αποσύνδεση', videoFinder: 'Αναζήτηση Βίντεο', videoScript: 'Σενάριο Βίντεο', capcutStudio: 'CapCut Studio' },
