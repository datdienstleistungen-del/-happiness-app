...
const translations = {
  de: {
    ...
    nexus: { leadRadar: 'Lead Radar', scanAuto: 'Automatischer Scan für dein Angebot:', findTriggers: 'Finde Trigger Events und Kaufsignale in deinem Markt', liveSearch: '🌐 Live Web Search', simulation: '🧪 Simulation', switchMode: 'Modus wechseln', signalsFound: 'Kaufsignale gefunden', hideSearch: 'Suche ausblenden', manualSearch: 'Manuell suchen', rescan: 'Erneut scannen', noSignals: 'Noch keine Kaufsignale gefunden.', searchActive: 'Suche läuft...', generatePitch: 'Nachricht generieren', generating: 'Generiere...', discard: 'Verwerfen', errorPipeline: 'Fehler beim Erstellen der Pipeline-Daten', noOfferingFound: 'Kein aktives Angebot gefunden', defineOfferingFirst: 'Um das Radar optimal zu nutzen, solltest du zuerst ein Angebot definieren.', toOfferingAnalysis: 'Zur Angebotsanalyse', scanning: 'Scannt Markt nach', targetGroup: 'Zielgruppe', buyingCycle: 'Kaufzyklus', budgetType: 'Budget-Typ', painPoints: 'Erkannte Schmerzpunkte', impact: 'Auswirkung', costs: 'Kosten', triggerEvents: 'Trigger Events', situationContext: 'Situation / Kontext (aus Radar)', companyName: 'Firmenname', previousContact: 'Vorheriger Kontakt', objection: 'Einwand', companyOrForum: 'Firmenname / Forum', contributionOrQuestion: 'Beitrag / Frage', workspaceDescription: 'Klicke auf eine Firma in deiner Pipeline, um den Pitch zu generieren', yourPipeline: 'Deine Pipeline', noLeads: 'Keine Leads in der Pipeline. Nutze das Lead Radar!', selectMode: 'Modus wählen', generateMessage: 'Nachricht generieren' , openPipeline: '? In Pipeline �ffnen', rejected: 'Aussortiert', analyzing: 'Wird analysiert...', kiReason: 'KI BEGR�NDUNG', kiReasonRejected: 'KI BEGR�NDUNG (ABGELEHNT)', noRatingYet: 'Noch nicht bewertet.', noHits: 'Keine Radar-Funde', noHitsDesc: 'Der automatische Cronjob hat noch keine relevanten Signale gefunden.', liveSearchTest: 'Live-Suche starten', deleteAll: 'Alle l�schen', autoFind: 'Auto-Finden', saveContact: 'Speichern', noContact: 'Kein Ansprechpartner', addContact: 'Kontaktperson hinzuf�gen', contactSaved: 'Kontakt gespeichert!', generatePitchAction: 'Pitch generieren', pitchGenerated: 'Dein Pitch ist fertig!', backToDashboard: 'Zur�ck zum Dashboard', myOfferingProfile: 'Mein Angebotsprofil', offeringDesc: 'Definiere dein zentrales Fallobjekt. Diese Daten sind das Fundament f�r die gesamte NeXus Intelligence.', yourProduct: 'Dein Produkt / Deine Dienstleistung', whoIsTarget: 'Wer ist dein idealer Kunde? (Zielgruppe)', whatIsValueProp: 'Was ist dein gr��tes Verkaufsargument (Value Proposition)?', saveProfile: 'Angebotsprofil speichern', savingProfile: 'Speichere Profil...', cancel: 'Abbrechen', activeProfile: 'Aktives Angebotsprofil', switchProfile: 'Profil wechseln:', productService: 'Produkt / Dienstleistung', targetGroupHeader: 'Zielgruppe', valuePropHeader: 'Value Proposition', nextSteps: 'N�chste Schritte in der NeXus Pipeline', toLeadRadar: 'Zum Lead Radar', findCompaniesDesc: 'Finde passende Unternehmen in deiner Zielgruppe', createNewProfile: 'Neues Profil erstellen', errRequired: 'Bitte f�lle alle Pflichtfelder aus.', errDbSave: 'Datenbank-Fehler.', actionPitch: 'Aktion (Pitch)', intelligenceTab: 'Intelligence'},
  ...
  en: {
    ...
    nexus: { leadRadar: 'Lead Radar', scanAuto: 'Automatic scan for your offering:', findTriggers: 'Find trigger events and buying signals in your market', liveSearch: '🌐 Live Web Search', simulation: '🧪 Simulation', switchMode: 'Switch Mode', signalsFound: 'buying signals found', hideSearch: 'Hide search', manualSearch: 'Manual search', rescan: 'Rescan', noSignals: 'No buying signals found yet.', searchActive: 'Search in progress...', generatePitch: 'Generate Message', generating: 'Generating...', discard: 'Discard', errorPipeline: 'Error creating pipeline data', noOfferingFound: 'No active offering found', defineOfferingFirst: 'To use the radar optimally, you should define an offering first.', toOfferingAnalysis: 'To Offering Analysis', scanning: 'Scanning market for', targetGroup: 'Target Group', buyingCycle: 'Buying Cycle', budgetType: 'Budget Type', painPoints: 'Identified Pain Points', impact: 'Impact', costs: 'Costs', triggerEvents: 'Trigger Events', situationContext: 'Situation / Context (from Radar)', companyName: 'Company Name', previousContact: 'Previous Contact', objection: 'Objection', companyOrForum: 'Company Name / Forum', contributionOrQuestion: 'Contribution / Question', workspaceDescription: 'Click on a company in your pipeline to generate a pitch', yourPipeline: 'Your Pipeline', noLeads: 'No leads in pipeline. Use the Lead Radar!', selectMode: 'Select Mode', generateMessage: 'Generate Message' , openPipeline: '? Open in Pipeline', rejected: 'Rejected', analyzing: 'Analyzing...', kiReason: 'AI REASONING', kiReasonRejected: 'AI REASONING (REJECTED)', noRatingYet: 'Not rated yet.', noHits: 'No Radar Hits', noHitsDesc: 'The automated cron job has not found any relevant signals yet.', liveSearchTest: 'Start Live Search', deleteAll: 'Delete all', autoFind: 'Auto-Find', saveContact: 'Save', noContact: 'No contact person', addContact: 'Add contact person', contactSaved: 'Contact saved!', generatePitchAction: 'Generate Pitch', pitchGenerated: 'Your pitch is ready!', openPipeline: '? Abrir en Pipeline', rejected: 'Rechazado', analyzing: 'Analizando...', kiReason: 'RAZONAMIENTO IA', kiReasonRejected: 'RAZONAMIENTO IA (RECHAZADO)', noRatingYet: 'A�n no calificado.', noHits: 'Sin resultados de Radar', noHitsDesc: 'El cron job autom�tico a�n no ha encontrado se�ales relevantes.', liveSearchTest: 'Iniciar B�squeda en Vivo', deleteAll: 'Borrar todo', autoFind: 'Auto-Buscar', saveContact: 'Guardar', noContact: 'Sin persona de contacto', addContact: 'A�adir persona de contacto', contactSaved: '�Contacto guardado!', generatePitchAction: 'Generar Pitch', pitchGenerated: '�Tu pitch est� listo!', backToDashboard: 'Back to Dashboard', myOfferingProfile: 'My Offering Profile', offeringDesc: 'Define your core offering. This data is the foundation for the entire NeXus Intelligence.', yourProduct: 'Your Product / Service', whoIsTarget: 'Who is your ideal customer? (Target Audience)', whatIsValueProp: 'What is your biggest selling point (Value Proposition)?', saveProfile: 'Save Offering Profile', savingProfile: 'Saving Profile...', cancel: 'Cancel', activeProfile: 'Active Offering Profile', switchProfile: 'Switch Profile:', productService: 'Product / Service', targetGroupHeader: 'Target Audience', valuePropHeader: 'Value Proposition', nextSteps: 'Next steps in the NeXus Pipeline', toLeadRadar: 'To Lead Radar', findCompaniesDesc: 'Find suitable companies in your target audience', createNewProfile: 'Create New Profile', errRequired: 'Please fill out all required fields.', errDbSave: 'Database Error.', actionPitch: 'Action (Pitch)', intelligenceTab: 'Intelligence', backToDashboard: 'Volver al panel', myOfferingProfile: 'Mi perfil de oferta', offeringDesc: 'Define tu oferta principal. Estos datos son la base de toda la NeXus Intelligence.', yourProduct: 'Tu producto / servicio', whoIsTarget: '�Qui�n es tu cliente ideal? (P�blico objetivo)', whatIsValueProp: '�Cu�l es tu mayor argumento de venta (Propuesta de valor)?', saveProfile: 'Guardar perfil de oferta', savingProfile: 'Guardando perfil...', cancel: 'Cancelar', activeProfile: 'Perfil de oferta activo', switchProfile: 'Cambiar perfil:', productService: 'Producto / Servicio', targetGroupHeader: 'P�blico objetivo', valuePropHeader: 'Propuesta de valor', nextSteps: 'Pr�ximos pasos en el Pipeline NeXus', toLeadRadar: 'Ir a Lead Radar', findCompaniesDesc: 'Encuentra empresas adecuadas en tu p�blico objetivo', createNewProfile: 'Crear nuevo perfil', errRequired: 'Por favor completa todos los campos requeridos.', errDbSave: 'Error de base de datos.', actionPitch: 'Acci�n (Pitch)', intelligenceTab: 'Inteligencia'},
