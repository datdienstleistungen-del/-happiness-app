...
const translations = {
  de: {
    nav: { home: 'Start', community: 'Community', friends: 'Freunde', marketplace: 'Marktplatz', jobs: 'Jobbörse', courses: 'Kurse', profile: 'Profil', notifications: 'Benachrichtigungen', history: 'Verlauf', admin: 'Admin', logout: 'Logout' },
  ...
  en: {
    nav: { home: 'Home', community: 'Community', friends: 'Friends', marketplace: 'Marketplace', jobs: 'Jobs', courses: 'Courses', profile: 'Profile', notifications: 'Notifications', history: 'History', admin: 'Admin', logout: 'Logout' },
  ...
  es: {
    nav: { home: 'Inicio', community: 'Comunidad', friends: 'Amigos', marketplace: 'Mercado', jobs: 'Empleos', courses: 'Cursos', profile: 'Perfil', notifications: 'Notificaciones', history: 'Historial', admin: 'Admin', logout: 'Salir' },
  ...
  fr: {
    nav: { home: 'Accueil', community: 'Communauté', friends: 'Amis', marketplace: 'Marché', jobs: 'Emplois', courses: 'Cours', profile: 'Profil', notifications: 'Notifications', history: 'Historique', admin: 'Admin', logout: 'Déconnexion' },
  ...
  it: {
    nav: { home: 'Home', community: 'Community', friends: 'Amici', marketplace: 'Mercato', jobs: 'Lavori', courses: 'Corsi', profile: 'Profilo', notifications: 'Notifiche', history: 'Cronologia', admin: 'Admin', logout: 'Esci' },
  ...
  nl: {
    nav: { home: 'Home', community: 'Community', friends: 'Vrienden', marketplace: 'Marktplaats', jobs: 'Banen', courses: 'Cursussen', profile: 'Profiel', notifications: 'Meldingen', history: 'Geschiedenis', admin: 'Admin', logout: 'Uitloggen' },
  ...
  el: {
    nav: { home: 'Αρχική', community: 'Κοινότητα', friends: 'Φίλοι', marketplace: 'Αγορά', jobs: 'Εργασίες', courses: 'Μαθήματα', profile: 'Προφίλ', notifications: 'Ειδοποιήσεις', history: 'Ιστορικό', admin: 'Διαχειριστής', logout: 'Αποσύνδεση' },
