...
const translations = {
  de: {
    ...
    nav: { home: 'Start', community: 'Community', friends: 'Freunde', marketplace: 'Marktplatz', jobs: 'Jobbörse', courses: 'Kurse', housing: 'Wohnungen', profile: 'Profil', wissenschaft: 'Wissenschaft', history: 'Verlauf', admin: 'Admin', logout: 'Logout', aiChat: 'AI Chat', videoMaker: 'Video Editor', more: 'Mehr', videoFinder: 'Video Finder', videoScript: 'Video-Drehbuch', capcutStudio: 'CapCut Studio' },
  ...
  es: {
    legal: { impressum: 'Aviso legal', privacy: 'Política de privacidad', terms: 'Términos y condiciones' },
    nav: { home: 'Inicio', community: 'Comunidad', friends: 'Amigos', marketplace: 'Mercado', jobs: 'Empleos', courses: 'Cursos', housing: 'Viviendas', profile: 'Perfil', wissenschaft: 'Ciencia', history: 'Historial', admin: 'Admin', logout: 'Salir', aiChat: 'AI Chat', videoMaker: 'Editor de Video', more: 'Más', videoFinder: 'Buscador de Videos', videoScript: 'Guion de Video', capcutStudio: 'CapCut Studio' },
    nexus: {leadRadar: 'Lead Radar', scanAuto: 'Escaneo automatico para tu oferta:', findTriggers: 'Encuentra eventos disparador y senales de compra en tu mercado', liveSearch: 'Busqueda en Vivo', simulation: 'Simulacion', switchMode: 'Cambiar Modo', signalsFound: 'senales de compra encontradas', hideSearch: 'Ocultar busqueda', manualSearch: 'Busqueda manual', rescan: 'Re-escanear', noSignals: 'Aun no se encontraron senales de compra.', searchActive: 'Busqueda en curso...', generatePitch: 'Generar Mensaje', generating: 'Generando...', discard: 'Descartar', errorPipeline: 'Error al crear datos del pipeline', noOfferingFound: 'No se encontro una oferta activa', defineOfferingFirst: 'Para usar el radar de forma optima, primero debes definir una oferta.', toOfferingAnalysis: 'Ir al Analisis de Oferta', scanning: 'Escaneando mercado para', targetGroup: 'Grupo Objetivo', buyingCycle: 'Ciclo de Compra', budgetType: 'Tipo de Presupuesto', painPoints: 'Puntos de Dolor Identificados', impact: 'Impacto', costs: 'Costos', triggerEvents: 'Eventos Disparador', situationContext: 'Situacion / Contexto (del Radar)', companyName: 'Nombre de la Empresa', previousContact: 'Contacto Anterior', objection: 'Objecion', companyOrForum: 'Nombre de Empresa / Foro', contributionOrQuestion: 'Contribucion / Pregunta', workspaceDescription: 'Haz clic en una empresa de tu pipeline para generar el pitch', yourPipeline: 'Tu Pipeline', noLeads: 'No hay leads en el pipeline. Usa el Lead Radar!', selectMode: 'Seleccionar Modo', generateMessage: 'Generar Mensaje', openPipeline: '? Abrir en Pipeline', rejected: 'Rechazado', analyzing: 'Analizando...', kiReason: 'RAZONAMIENTO IA', kiReasonRejected: 'RAZONAMIENTO IA (RECHAZADO)', noRatingYet: 'Aun no calificado.', noHits: 'Sin resultados de Radar', noHitsDesc: 'El cron job automatico aun no ha encontrado senales relevantes.', liveSearchTest: 'Iniciar Busqueda en Vivo', deleteAll: 'Borrar todo', autoFind: 'Auto-Buscar', saveContact: 'Guardar', noContact: 'Sin persona de contacto', addContact: 'Anadir persona de contacto', contactSaved: 'Contacto guardado!', generatePitchAction: 'Generar Pitch', pitchGenerated: 'Tu pitch esta listo!' },
  ...
  fr: {
    legal: { impressum: 'Mentions légales', privacy: 'Politique de confidentialité', terms: 'CGU' },
    nav: { home: 'Accueil', community: 'Communauté', friends: 'Amis', marketplace: 'Marché', jobs: 'Emplois', courses: 'Cours', housing: 'Logements', profile: 'Profil', wissenschaft: 'Science', history: 'Historique', admin: 'Admin', logout: 'Déconnexion', aiChat: 'AI Chat', videoMaker: 'Editeur Video', more: 'Plus', videoFinder: 'Recherche Vidéo', videoScript: 'Script Vidéo', capcutStudio: 'CapCut Studio' },
  ...
  it: {
    legal: { impressum: 'Note legali', privacy: 'Informativa sulla privacy', terms: 'Termini e condizioni' },
    nav: { home: 'Home', community: 'Community', friends: 'Amici', marketplace: 'Mercato', jobs: 'Lavori', courses: 'Corsi', housing: 'Alloggi', profile: 'Profilo', wissenschaft: 'Scienza', history: 'Cronologia', admin: 'Admin', logout: 'Esci', aiChat: 'AI Chat', videoMaker: 'Editor Video', more: 'Altro', videoFinder: 'Cerca Video', videoScript: 'Copione Video', capcutStudio: 'CapCut Studio' },
  ...
  nl: {
    legal: { impressum: 'Colofon', privacy: 'Privacybeleid', terms: 'Algemene voorwaarden' },
    nav: { home: 'Home', community: 'Community', friends: 'Vrienden', marketplace: 'Marktplaats', jobs: 'Banen', courses: 'Cursussen', housing: 'Woningen', profile: 'Profiel', wissenschaft: 'Wetenschap', history: 'Geschiedenis', admin: 'Admin', logout: 'Uitloggen', aiChat: 'AI Chat', videoMaker: 'Video Editor', more: 'Meer', videoFinder: 'Videozoeker', videoScript: 'Videoscenario', capcutStudio: 'CapCut Studio' },
  ...
  el: {
    legal: { impressum: 'Νομικές πληροφορίες', privacy: 'Πολιτική Απορρήτου', terms: 'Όροι Χρήσης' },
    nav: { home: 'Αρχική', community: 'Κοινότητα', friends: 'Φίλοι', marketplace: 'Αγορά', jobs: 'Εργασίες', courses: 'Μαθήματα', housing: 'Κατοικίες', profile: 'Προφίλ', wissenschaft: 'Επιστήμη', history: 'Ιστορικό', admin: 'Διαχειριστής', logout: 'Αποσύνδεση', videoFinder: 'Αναζήτηση Βίντεο', videoScript: 'Σενάριο Βίντεο', capcutStudio: 'CapCut Studio' },
