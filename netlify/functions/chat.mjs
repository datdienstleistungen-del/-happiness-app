...
P.S. Ich bin vorhin auf der Seite nexus-hit [.] netlify [.] app gewesen (einfach die Leerzeichen und Klammern beim Abtippen im Browser weglassen), da dort gerade eine neue Community im Aufbau ist, die genau diese Fälle sammelt. Weil alles noch neu ist, wird dein Beitrag dort sofort gesehen.

[IF INPUT IS ENGLISH — APPEND EXCLUSIVELY]:
P.S. I actually came across the site nexus-hit [.] netlify [.] app earlier (just leave out the spaces and brackets when typing it into your browser), since they are building a new community over there that collects exactly these kinds of cases. Because everything is still brand new, your post will be noticed right away.
...
${message}`
    ...
    if (isContentGeneration) {
      ...
      finalSystemPrompt = `${finalSystemPrompt}\n\n### 🎭 ERZWUNGENE TONALITÄT FÜR DIESEN GENERIERUNGS-REQUEST:\n- Nutze zwingend folgende Tonalität und Perspektive: "${randomTonality}".\n\n### 🚫 STRENGE QUALITÄTS-REGELN & PROMPT-ENGINEERING-VORGABEN (TIKTOK CREATOR ACADEMY STANDARDS):\n1. AUTONOME NISCHEN-RECHERCHE:\n   - Wenn die Eingabe des Nutzers nur ein grobes Überthema, Stichwort oder eine Nische ist (z. B. "Fußball-Kuriosität", "Verrückter Geschichtsfakt", "Psychologie-Experiment"), frage NIEMALS nach weiteren Details oder einer Ausarbeitung. Generiere die Story komplett selbstständig!\n   - Suche in deinem Wissensschatz nach einer echten, historisch belegten oder kuriosen Anekdote, die Menschen sofort fesselt (z. B. Indien 1950 Barfuß-Verbot bei der WM, das Seehund-Dribbling im Fußball, berühmte psychologische Phänomene/Experimente).\n\n2. METAPHERN-ZWANG ZU HAPPINESS & DAS "VORHER/NACHHER"-PRINZIP:\n   - Die gefundene Anekdote/Kuriosität MUSS im Hauptteil (Body) als elegante psychologische Metapher (Brücke) genutzt werden, um auf die Kernthemen der Happiness-App überzuleiten: Fokus-Verlust, Smartphone-Sucht, Gewohnheiten oder Lebensziele.\n   - Der Hauptteil (Body) darf keine lose Aufzählung sein, sondern MUSS der offiziellen TikTok Creator Academy Story-Struktur folgen:\n     * Hook / Einstieg: 0-3s\n     * Problem-Identifikation (Wie macht es die breite Masse falsch?): 3-7s\n     * Lösung & Aha-Moment (Wie macht man es richtig?): 7-12s\n     * Schneller, nutzenbasierter Call-to-Action (CTA): 12-15s\n   - Kontrastiere immer das konkrete Anekdoten-Beispiel statt theoretischer Lehrbuch-Tipps.\n\n3. VERBOT VON MARKTSCHREIER-FLOSKELN & TIKTOK-HOOK-SCHRANKE:\n   - Verwende NIEMALS billige Klickköder-Anmache, platte Werbe-Slogans oder marktschreierische Phrasen wie: "Hör sofort auf...", "Dieses eine Geheimnis wird alles verändern...", "Tu das nie...", "Der größte Fehler...", "Wusstest du schon...", "Machst du auch diesen Fehler...".\n   - Der Einstieg (Hook) MUSS über ein reales, greifbares Alltagsproblem oder eine kurze Story passieren (z. B. "3 Monate gepostet. 0 Ergebnisse. Dann habe ich eine Sache geändert..."). Wähle eine unkonventionelle Metapher, die perfekt zur Tonalität "${randomTonality}" passt.\n   - Jedes Skript MUSS in den ersten 2 Sekunden ein glasklares, unmissverständliches Wertversprechen (Value Proposition) für den Zuschauer enthalten. Beantworte sofort die Frage: "Warum sollte ich hier hängenbleiben?" und rede nicht lange um den heißen Brei herum.\n\n4. AUDIO-VISUELLER SYNC-ZWANG (REGIE-ANWEISUNG):\n   - Füge in den Regie- und CapCut-Abschnitten des Skripts explizit hinzu, dass Text-Overlays (Untertitel) in den ersten 3 Sekunden absolut synchron mit lauten Soundeffekten ("Pop", "Whoosh") geschaltet werden müssen, um die Initial-Retention zu maximieren.\n\n5. RADIKALE LÄNGENBREMSE (KNACKIGES PACING):\n   - Die Gesamtwortanzahl des gesprochenen Skripts darf 120 Wörter NIEMALS überschreiten.\n   - Halte die Sätze extrem kurz, schneide jedes Füllwort radikal heraus. Der Übergang zum Loop muss blitzschnell und ohne langes Gerede passieren.\n`
      reqTemperature = 0.85
